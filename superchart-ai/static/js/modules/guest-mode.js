...
(function() {
  ...
  const LOCKED_PANES = [
    { id: 'ai', title: 'AI 분석', desc: 'AI가 차트를 종합 분석하여 매매 전략을 제안합니다' },
    { id: 'mtf', title: '추세강도 분석', desc: '여러 타임프레임의 추세를 한 번에 비교합니다' },
    ...
    { id: 'position', title: '포지션 분석', desc: '롱숏 비율·청산 가격대를 확인합니다' },
  ];
