...
(function() {
  ...
  const LEDGER_LABEL = {
    referral_signup: '친구 초대 보상', referral_payment: '친구 초대 보상', signup_bonus: '가입 축하 포인트',
    ...
    return `
      ...
      <details class="pt-card pt-policy-toggle" style="margin-top:12px">
        ...
        <ul class="pt-policy-list" style="margin-top:10px">
          ...
          <li>월 최대 친구 초대 보상 50,000 P · 포인트는 유효기간이 짧은 순으로 사용</li>
        </ul>
