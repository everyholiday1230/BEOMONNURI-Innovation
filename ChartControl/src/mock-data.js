  ...
  const LAYOUT_PRESETS = {
    ...
    */
    'standard-trader': {
      ...
      cols: 48,
      widgets: [
        { id: 'market',     type: 'marketWatch',  x: 0,  y: 0, w: 8, h: 16, minW: 6, minH: 6 },
        { id: 'chart',      type: 'chart',        x: 8,  y: 0, w: 14, h: 11, minW: 12, minH: 6 },
        { id: 'positions',  type: 'positions',    x: 8,  y: 11, w: 26, h: 5, minW: 16, minH: 3 },
        { id: 'ai',         type: 'aiCopilot',    x: 22,  y: 0, w: 12, h: 11, minW: 10, minH: 10 },
        { id: 'orderbook',  type: 'orderBook',    x: 34,  y: 0, w: 6, h: 11, minW: 6, minH: 6 },
        { id: 'trades',     type: 'recentTrades', x: 34,  y: 11, w: 6, h: 5, minW: 6, minH: 3 },
        { id: 'orderEntry', type: 'orderEntry',   x: 40,  y: 0, w: 8, h: 11, minW: 6, minH: 8 },
        { id: 'assets',     type: 'assetsRisk',   x: 40,  y: 11, w: 8, h: 5, minW: 6, minH: 3 },
      ],
    },
    ...
    */
    'ai-workspace': {
      ...
      cols: 48,
      widgets: [
        { id: 'market',     type: 'marketWatch', x: 0,  y: 0, w: 6, h: 16, minW: 6, minH: 6 },
        { id: 'chart',      type: 'chart',       x: 6,  y: 0, w: 20, h: 11, minW: 12, minH: 6 },
        { id: 'positions',  type: 'positions',   x: 6,  y: 11, w: 20, h: 5, minW: 16, minH: 3 },
        { id: 'ai',         type: 'aiCopilot',   x: 26,  y: 0, w: 14, h: 11, minW: 10, minH: 10 },
        { id: 'assets',     type: 'assetsRisk',  x: 26,  y: 11, w: 14, h: 5, minW: 6, minH: 3 },
        { id: 'orderEntry', type: 'orderEntry',  x: 40,  y: 0, w: 8, h: 16, minW: 6, minH: 8 },
      ],
    },
    ...
    */
    'chart-focus': {
      ...
      widgets: [
        { id: 'market',     type: 'marketWatch', x: 0,  y: 0, w: 6, h: 16, minW: 6, minH: 6 },
        { id: 'chart',      type: 'chart',       x: 6,  y: 0, w: 34, h: 12, minW: 12, minH: 6 },
        { id: 'positions',  type: 'positions',   x: 6,  y: 12, w: 34, h: 4, minW: 16, minH: 3 },
        { id: 'orderEntry', type: 'orderEntry',  x: 40,  y: 0, w: 8, h: 10, minW: 6, minH: 8 },
        { id: 'assets',     type: 'assetsRisk',  x: 40,  y: 10, w: 8, h: 6, minW: 6, minH: 3 },
      ],
    },
    ...
    */
    'scalper': {
      ...
      widgets: [
        { id: 'market',     type: 'marketWatch',  x: 0,  y: 0, w: 6, h: 16, minW: 6, minH: 6 },
        { id: 'chart',      type: 'chart',        x: 6,  y: 0, w: 22, h: 10, minW: 12, minH: 6 },
        { id: 'positions',  type: 'positions',    x: 6,  y: 10, w: 22, h: 6, minW: 16, minH: 3 },
        { id: 'orderbook',  type: 'orderBook',    x: 28,  y: 0, w: 10, h: 10, minW: 6, minH: 6 },
        { id: 'trades',     type: 'recentTrades', x: 28,  y: 10, w: 10, h: 6, minW: 6, minH: 3 },
        { id: 'orderEntry', type: 'orderEntry',   x: 38,  y: 0, w: 10, h: 11, minW: 6, minH: 8 },
        { id: 'assets',     type: 'assetsRisk',   x: 38,  y: 11, w: 10, h: 5, minW: 6, minH: 3 },
      ],
    },
  };
