...
(function () {
  ...
  window.QTI18n.register(
    'ja',
    {
      ...
      help_center_3910ce: '資金と手数料',
      help_center_42b43b: "よくある質問 · ガイド · お問い合わせ",
      help_center_45bbd7: '入出金はどこで行いますか？',
      ...
      help_center_72f72a: 'この環境ではまだ使えません。AI プロバイダーが接続されるまで、コパイロットは価格水準を出しません — モデルなしでエントリーや損切り価格を作るのは、何も言わないより悪いことです。測定できない的中率も公表しません。有効化されても、AI が自動で発注することはありません。',
      help_center_7901e1: '資金は取引所に · 当社の上乗せ手数料なし',
      help_center_7b944c: "アカウントが停止されたらどうなりますか？",
      help_center_87ad98: "シグナル · オーバーレイ · 精度",
      help_center_8c548e: "1対1の専任マネージャー",
      help_center_8f8fe0: '当サービスではなく、ご自身の取引所で行います。資金はご自身の取引所口座に置かれたままで、当社が受け取ることも預かることもありません。お願いする API キーは出金権限を意図的に除外しています。入出金の遅延は取引所へお問い合わせください — 当社はチェーンを見ることができません。',
      ...
      help_center_b9a588: '取引手数料は取引所がご自身の口座に対して課すもので、料率は取引所の規定に従います。当社が上乗せする手数料はありません。当社の収益は取引所のブローカー・リベートであり、そのため当社経由でも追加費用は発生しません。',
      help_center_c1c49c: 'メールアドレスとパスワードで登録し、アドレスを確認します。本人確認書類は当社では求めません — 本人確認は取引所の口座開設時に取引所が行います。ログイン後、ウォレット画面で取引所の API キーを接続してください。',
      help_center_c46850: "AI の自動売買を有効にできますか？",
      help_center_c5eed0: 'いいえ。すべての注文は送信前にお客様の承認が必要で、無人の自動売買モードはありません。AI 分析が接続されると注文の下書きは作れますが、送信は常にお客様の別の操作です。',
      help_center_d67afc: 'AI 分析は使えますか？',
      help_center_dc20f4: "取引",
      help_center_dda31f: "メールを送る",
      help_center_ddc217: 'ログイン時に理由が表示され、監査ログにも記録されます。求められた内容を下のお問い合わせフォームから返信いただければ、担当者が確認します。停止によって資金が影響を受けることはありません — 資金はご自身の取引所口座にあり、当社は動かせません。',
      ...
      strat_follow_ok: '{symbol} でフォローしました。マイストラテジーで管理できます。',
      strat_follow_failed: 'フォローできませんでした。何も保存されていません — 再試行してください。',
    },
