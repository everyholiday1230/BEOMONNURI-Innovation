...
(function () {
  ...
  window.QTI18n.register(
    'en',
    {
      ...
      landing_hero_line1: 'Stop squinting at charts.',
      landing_4c1fc3: 'Just ask.',
      landing_af3947: ' The AI marks it on screen.',
      landing_5f6b64: 'Tell ChartControl AI what you want to see and it marks support, resistance, trend lines and indicators on the chart in front of you. Your levels, your decision, in seconds instead of minutes.',
      landing_44cbb3: 'Drag and resize on a 96-column grid · 4 presets (Standard Trader / AI Workspace / Chart Focus / Scalper)',
      landing_40f668: 'AI approval ≠ order submission · 17-gate risk check · trading-mode stripe always visible',
      landing_69704c: 'Mood tags · free-text notes · daily profit and loss',
