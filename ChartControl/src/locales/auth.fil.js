...
(function () {
  ...
  window.QTI18n.register(
    'fil',
    {
      ...
      landing_44cbb3: 'I-drag at i-resize sa 96-column grid · 4 presets (Standard Trader / AI Workspace / Chart Focus / Scalper)',
      landing_40f668: 'Pag-apruba ng AI ≠ pagsumite ng order · 17-gate risk check · laging nakikita ang trading-mode stripe',
      landing_69704c: 'Mood tags · malayang tala · araw-araw na tubo at lugi',
