...
(function () {
  ...
  window.QTI18n.register(
    'pt',
    {
      ...
      landing_hero_line1: 'Pare de apertar os olhos no gráfico.',
      landing_4c1fc3: 'Basta perguntar.',
      landing_af3947: ' A IA marca na tela.',
      landing_5f6b64: 'Diga ao ChartControl AI o que quer ver e ele marca suportes, resistências, linhas de tendência e indicadores no gráfico à sua frente. Seus níveis, sua decisão, em segundos em vez de minutos.',
      landing_44cbb3: 'Arraste e redimensione em uma grade de 96 colunas · 4 presets (Standard Trader / AI Workspace / Chart Focus / Scalper)',
      landing_40f668: 'Aprovação da IA ≠ envio da ordem · 17 verificações de risco · barra de modo de operação sempre visível',
      landing_69704c: 'Etiquetas de humor · notas livres · lucro e perda diários',
