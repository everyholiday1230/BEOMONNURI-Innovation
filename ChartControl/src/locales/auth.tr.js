...
(function () {
  ...
  window.QTI18n.register(
    'tr',
    {
      ...
      landing_4c1fc3: 'Yapay zeka yanıtlar',
      landing_af3947: ' — ne yapacağınıza siz karar verirsiniz.',
      landing_5f6b64: 'Gündelik dille sorun; ChartControl AI, canlı piyasa verilerini kullanarak baktığınız grafik üzerinde destek/direnç, trend çizgileri ve göstergeleri işaretlemenize yardım eder. Her şey sizin oluşturduğunuz ve karar verdiğiniz bir taslaktır — bu bir grafik aracıdır, yatırım tavsiyesi değildir.',
      landing_44cbb3: 'Serbestçe sürükleyip boyutlandırın · 7 hazır ayar (Standard / Scalper / Multi / AI ve daha fazlası)',
      landing_40f668: 'Yapay zeka onayı ≠ emir gönderimi · 9 aşamalı risk kontrolü · simülasyon şeridi her zaman görünür',
      landing_69704c: 'Ruh hali etiketleri · günün saatine göre performans · otomatik formasyon tespiti',
