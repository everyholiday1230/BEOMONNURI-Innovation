...
(function () {
  ...
  window.QTI18n.register(
    'zh',
    {
      ...
      ai_overlay_updated: '✏️ 已修改 {fields}',
      ai_overlay_updated_partial: '✏️ 已修改 {done}。{skipped} 无法修改 — 线条颜色和粗细由图表决定，不可调整。',
      ai_overlay_update_unsupported: '无法修改 {fields}。线条颜色和粗细由图表决定（AI 草稿为虚线，您自己画的为实线），这里无法调整。',
      ai_drew_trendline: '📐 已画出从 {from} 到 {to} 的趋势线',
      ai_drew_level: '📍 已在 {price} 画出一条线',
      ai_drew_support: '📍 已在 {price} 画出支撑',
      ai_drew_resistance: '📍 已在 {price} 画出阻力',
      ai_drew_entry_zone: '🎯 已画出入场区间 {lo} – {hi}',
      ai_drew_stop: '🛑 已在 {price} 画出止损线',
      ai_drew_target: '🎯 已在 {price} 画出目标 {n}',
      ai_drew_invalidation: '⚠ 已在 {price} 画出失效价位',
      ai_drew_long_marker: '▲ 已在 {price} 标记做多',
      ai_drew_short_marker: '▼ 已在 {price} 标记做空',
