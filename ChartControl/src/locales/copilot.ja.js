...
(function () {
  ...
  window.QTI18n.register(
    'ja',
    {
      ...
      ai_drew_resistance: '📍 {price} にレジスタンスを描きました',
      ai_drew_entry_zone: '🎯 エントリーゾーン {lo} – {hi} を描きました',
      ai_drew_stop: '🛑 {price} に損切りラインを描きました',
      ai_drew_target: '🎯 目標 {n} を {price} に描きました',
      ai_drew_invalidation: '⚠ {price} に無効化ラインを描きました',
      ai_drew_long_marker: '▲ {price} にロングの印を付けました',
      ai_drew_short_marker: '▼ {price} にショートの印を付けました',
      sv_plan_required: "保存は有料プランが必要です",
      sv_name_label: "名前を付ける",
      sv_save: "保存",
      ai_my_setup: "◉ 自分のセットアップ",
      ai_setup_checked: "検証済み",
      ai_setup_missing: "不足",
      ai_setup_against: "このセットアップに反する根拠",
      ai_setup_against_hint: "やめる理由ではありません — このセットアップが乗り越えるべき点です。",
      ai_setup_drawn: "📊 チャートに {n} 件を描画 · {items}",
      ai_setup_nothing_drawn: "描画したものはありません — 使える価格がありませんでした。",
      ai_setup_no_entry: "エントリー価格がないため、下書きを作成できません。",
