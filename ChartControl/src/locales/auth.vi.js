...
(function () {
  ...
  window.QTI18n.register(
    'vi',
    {
      ...
      landing_4c1fc3: 'AI trả lời',
      landing_af3947: ' — bạn quyết định phải làm gì.',
      landing_5f6b64: 'Hãy hỏi bằng ngôn ngữ thông thường và ChartControl AI giúp bạn đánh dấu hỗ trợ/kháng cự, đường xu hướng và các chỉ báo trên biểu đồ bạn đang xem, dựa trên dữ liệu thị trường trực tiếp. Mọi thứ đều là bản nháp do bạn tạo và bạn quyết định — đây là công cụ vẽ biểu đồ, không phải lời khuyên đầu tư.',
