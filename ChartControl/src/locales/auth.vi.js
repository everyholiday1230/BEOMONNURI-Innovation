...
(function () {
  ...
  window.QTI18n.register(
    'vi',
    {
      ...
      landing_hero_line1: 'Đừng căng mắt dò biểu đồ nữa.',
      landing_4c1fc3: 'Chỉ cần hỏi.',
      landing_af3947: ' AI vẽ ngay trên màn hình.',
      ...
      landing_44cbb3: 'Kéo và thay đổi kích thước trên lưới 96 cột · 4 bố cục sẵn (Standard Trader / AI Workspace / Chart Focus / Scalper)',
      landing_40f668: 'AI chấp thuận ≠ gửi lệnh · 17 bước kiểm tra rủi ro · thanh chế độ giao dịch luôn hiển thị',
      landing_69704c: 'Thẻ tâm lý · ghi chú tự do · lãi lỗ theo ngày',
