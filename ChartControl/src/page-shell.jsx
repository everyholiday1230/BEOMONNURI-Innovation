...
(function () {
  ...
  const SIDEBAR_ITEMS = [
    ...
    { section: 'trading', labelKey: 'nav_leaderboard', icon: 'Chart',       route: '/leaderboard',    roles: ['user','ops','admin','super'] },
    /*
        ...
        <div className="app-sidebar-v2__scroll">
          {collapsed ? (
            ...
            {/*
               ...
               ★ 중괄호로 감싸야 주석이다. 중괄호 없이 블록 주석 기호만 쓰면
                 JSX 자식 **글자**가 되어 주석 내용이 그대로 화면에 나온다 —
                 실제로 접힌 사이드바에 이 문단이 노출됐다(운영자 보고).
               ★ 주석 본문에 닫는 기호를 적지 말 것. 주석이 그 자리에서 끝나고
                 나머지가 JSX 식으로 파싱돼 화면 전체가 죽는다(방금 겪었다).
            */}
