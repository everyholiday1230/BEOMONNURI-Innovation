...
(() => {
  ...
  const partnerLogos = {
    'mss': { src: 'assets/img/logos/partners/mss.png', webp: 'assets/img/logos/partners/mss.webp', alt: '중소벤처기업부 공식 로고' },
    'fin-nh': { src: 'assets/img/logos/partners/nonghyup.png', webp: 'assets/img/logos/partners/nonghyup.webp', alt: '농협 공식 로고' },
    'inv-posco': { src: 'assets/img/logos/partners/posco-technology-investment.png', alt: '포스코기술투자 공식 로고' },
    'edu-dku': { src: 'assets/img/logos/partners/dankook-university.png', webp: 'assets/img/logos/partners/dankook-university.webp', alt: '단국대학교 공식 로고' },
    'lab-knl': { src: 'assets/img/logos/partners/knal-kor.png', webp: 'assets/img/logos/partners/knal-kor.webp', alt: '한국나노분석랩 공식 로고' },
    ...
    'youth-foundation': { src: 'assets/img/logos/partners/youth-foundation.png', webp: 'assets/img/logos/partners/youth-foundation.webp', alt: '청년재단 공식 로고' },
    /* TEMP-HIDDEN(LOCALMOTIVE / 2026-08-04): 재노출 시 아래 한 줄의 주석만 해제
    'localmotive': { src: 'assets/img/logos/partners/localmotive.png', webp: 'assets/img/logos/partners/localmotive.webp', alt: '(주)로컬모티브 공식 로고' },
    */
    'gov-gg': { src: 'assets/img/logos/partners/gbsa.png', webp: 'assets/img/logos/partners/gbsa.webp', alt: '경기도경제과학진흥원 공식 로고' },
    'moel': { src: 'assets/img/logos/partners/moel.png', webp: 'assets/img/logos/partners/moel.webp', alt: '고용노동부 공식 로고' },
  ...
  const collectLogos = () => {
    $$5('#partner-marquee-track .pm-item').forEach(item => {
      ...
      logoMap[id] = logoHtml(id, img.src, img.alt || partnerLogos[id]?.alt || '', img.dataset.webp);
    });
  };
  ...
  const ensureFallbackLogos = () => {
    partnerOrder.forEach((id) => {
      ...
      if (!fallback) return;
      logoMap[id] = logoHtml(id, fallback.src, fallback.alt, fallback.webp);
    });
  };
